...
# i have just changed fight method in Animal class
...
class Animal:
    ...
    def symbol(self):
        gender = 'M' if self.gender else 'F'
        return type(self).__name__[0] + gender + str(self.strength)
    ...
    class FightController:
        ...
        def fight(animal1, animal2):
            ...
            if type(animal1) == type(animal2):
                return animal1.fight_same_s(animal2)
