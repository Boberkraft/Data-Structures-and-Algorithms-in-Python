...
I think the round robin algorythm is in next chapter, so i will skip it for now
and do it when time comes. Why look in google when you can just read the next chapter?
"""